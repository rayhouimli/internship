...
export declare class ProjectFeatures {
    ...
    getFeaturesForProject<T = Models.ProjectFeatures>(parameters: Parameters.GetFeaturesForProject | string, callback: Callback<T>): Promise<void>;
    /** Returns the list of features for a project. */
    getFeaturesForProject<T = Models.ProjectFeatures>(parameters: Parameters.GetFeaturesForProject | string, callback?: never): Promise<T>;
